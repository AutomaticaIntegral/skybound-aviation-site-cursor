  ...
  return <section id="home" className="relative pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 bg-fixed">
        ...
        <div className="absolute inset-0 z-0 transform scale-[1.02] transition-transform duration-[30000ms] ease-linear hover:scale-[1.08]">
          <img src="https://images.unsplash.com/photo-1543078468-d0ad660d6148?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80" alt="Aircraft in flight" className="object-cover w-full h-full" />
        </div>
      </div>
